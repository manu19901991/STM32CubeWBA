...
P2PR_APP_ConnHandleNotEvt_t P2PRHandleNotification;
GATT_CLIENT_APP_ConnHandle_Notif_evt_t clientHandleNotification;

static const char a_GapDeviceName[] = {  'P', 'e', 'e', 'r', ' ', 't', 'o', ' ', 'P', 'e', 'e', 'r', ' ', 'R', 'o', 'u', 't', 'e', 'r' }; /* Gap Device Name */
...
{
  8, AD_TYPE_COMPLETE_LOCAL_NAME, 'p', '2', 'p', 'R', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      P2PRHandleNotification.EvtOpcode = P2PR_DISCON_HANDLE_EVT;
      P2PRHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      P2PR_APP_EvtRx(&P2PRHandleNotification);
      /* USER CODE BEGIN EVT_DISCONN_COMPLETE */
      uint8_t result;
      result = P2PR_getIndexFromConnHdl(p_disconnection_complete_event->Connection_Handle);
      if(result == 0xFF)
      {
        APP_DBG_MSG(">>== DISCONNECTION OF THE APPLICATION\n");
        APP_DBG_MSG("     - restart Advertising\n");
        APP_BLE_Procedure_Gap_Peripheral(PROC_GAP_PERIPH_ADVERTISE_START_FAST);
      }
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          P2PRHandleNotification.EvtOpcode = P2PR_CONN_HANDLE_EVT;
          P2PRHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          P2PR_APP_EvtRx(&P2PRHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          P2PRHandleNotification.EvtOpcode = P2PR_CONN_HANDLE_EVT;
          P2PRHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          P2PR_APP_EvtRx(&P2PRHandleNotification);

          /* USER CODE BEGIN HCI_EVT_LE_CONN_COMPLETE */
          if (p_conn_complete->Role == HCI_ROLE_CENTRAL)
          {
            UTIL_SEQ_SetEvt(1 << CFG_IDLEEVT_NODE_CONNECTION_COMPLETE);
          }
